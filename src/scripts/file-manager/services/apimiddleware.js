(function(angular) {
  ...
  angular
    ...
    .service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler',
      function ($window, fileManagerConfig, ApiHandler) {
        ...
        ApiMiddleware.prototype.list = function(params, path, customDeferredHandler) {
          return this.apiHandler.list(params, fileManagerConfig.listUrl, this.getPath(path), customDeferredHandler);
        };
